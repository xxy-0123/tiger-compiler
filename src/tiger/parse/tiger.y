...
|
  exp AND exp  
  {
    $$ = new absyn::IfExp(scanner_.GetTokPos(), $1, $3, new absyn::IntExp(scanner_.GetTokPos(), 0));
  }
|
  exp OR exp  
  {
    $$ = new absyn::IfExp(scanner_.GetTokPos(), $1, new absyn::IntExp(scanner_.GetTokPos(), 1), $3);
  }
|
  exp PLUS exp  
  {
...
|
  MINUS exp  
  {
    //$$ = new absyn::OpExp(scanner_.GetTokPos(), absyn::MINUS_OP, 0, $2);
...
|
  IF exp THEN exp
  {
    $$ = new absyn::IfExp(scanner_.GetTokPos(), $2, $4, NULL);
  }
|
...
expseq:
  {
    $$ = new absyn::SeqExp(scanner_.GetTokPos(), new absyn::ExpList(NULL));
  }
|
  sequencing_exps 
  {
